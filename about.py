def about_app():
    ...
    print('The app lets users such as the player or coach to be able to view stats about their team, to track their performance against other teams throughout the history of the tournament')
    print()
